...
app.post("/register", async (req,res)=>{
    ...
    try{
        ...
        // Validate kya uske andar firstName(this is called API level validation)
        validUser(req.body);
...
app.post("/login", async(req,res)=>{
    ...
    try{
        ...
        // validate karna
        // during login you have to find the user by id in  your database but how user know the id 
