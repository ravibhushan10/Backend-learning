...
// To handle error : when you fetch the data from the database then sometimes backend failed to connect database then database gives you some error , then you have to manage the error
