...
app.patch("/user", async(req,res)=>{
    ...
    try{
        ...
        // during time of update it not recheck the validater or all things present in schema,by default it check/validate for only new created object/document
        // you have to recheck during update (runvalidators:true)
